...
local colors = {
  ...
  bg_dark = '#212121', -- Dark gray for cursor line
  bg_light = '#2e2e2e', -- Lighter gray for selections
  bg_highlight = '#3d3d3d', -- Highlighted backgrounds

  -- Main text - all code in same gray
  text_gray = '#c0c0c0', -- Main text color (silver)

  -- Primitives & comments - distinguishable grays
  string_gray = '#ffffff', -- Strings (white)
  comment_gray = '#787878', -- Comments (darker gray)

  -- Borders
  border_gray = '#606060', -- Borders
  subtle_gray = '#404040', -- Subtle elements
...
function M.load()
  ...
  highlight('CursorLineNr', { fg = colors.bg_black, bg = colors.bg_highlight })
  ...
  highlight('LspReferenceText', { fg = colors.text_gray, bg = colors.bg_highlight })
  highlight('LspReferenceRead', { fg = colors.text_gray, bg = colors.bg_highlight })
  highlight('LspReferenceWrite', { fg = colors.text_gray, bg = colors.bg_highlight })
